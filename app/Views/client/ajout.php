...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="<?php echo base_url('css/banque.css');?>"/>
    <title>Banque</title>
</head>
<body>
    <header id="top" class="bg-white">
        <nav  class="flex-row">
            <div class="logo">
            <a href="#"><img src="<?php echo base_url('img/logo-Recupere.png');?>" alt="logo banque du peuple" class="image"/></a>
            </div>
        <div class="texte plus-grand text-center">
            <h1 class="title-banque"> Banque du peuple </h1>
        </div>
        <div class="user-logo">
            <a href="#"><img src="<?php echo base_url('img/user.jpeg');?>" alt="logo banque du peuple" class="image"/></a>
        </div>
        </nav>
    </header>
    <main class="flex-row">
        ...
        <div class="info-user flex-row">
            ...
            <div class="site-bar">
                <div class="marge">
                    <img src="<?php echo base_url('img/compte.png');?>" alt="ok" class="icone" />
                        ...
                        <div id="form_existant">
                            <fieldset class="flex-col">
                                ...
                                <div class="form-group flex-row-between">
                                    ...
                                    <a href="#"><img src="<?php echo base_url('img/search.png');?>" alt="" class="search" onclick="searchValid()" /></a>
                                </div>
                            </fieldset>
                        </div>
                        <div id="form_compte" >
...
<script src="<?php echo base_url('js/banque.js');?>"></script>
